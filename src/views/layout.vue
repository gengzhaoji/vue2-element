    ...
    <div id="layout">
        <el-container>
            ...
            <el-header class="header" height="80px">
                <div class="title" :style="{ width: aside_width }">
                    <transition name="sidebarLogoFade">
                        <div v-if="collapse" key="collapse">
                            <img class="juzhong_transform" src="@/assets/img/logo.png" alt="" />
                        </div>
                ...
                <div class="f1 flex">
                    <i class="" @click.prevent="collapse = !collapse" :class="[collapse ? 'icon-menu2' : 'icon-menu', 'btn']"></i>
                    <div class="message f1">
                        <div class="li">
                            <el-avatar class="tou" :src="$store.getters.avatar"></el-avatar>
            ...
            <el-container>
                <el-aside :width="aside_width" :class="{ collapse: !collapse }">
                    <xdh-menu-toggle
                        class="menu"
                        :data="menus"
                        :collapse="collapse"
