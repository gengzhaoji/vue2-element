/**
 * 复制内容到剪切板
 * @module utils/directives/clipboard
 * @author 耿朝继
 */
 ...
 *
 * @example
 * <com-button v-clipboard="复制的文本">复制</com-button>
 * <com-button v-clipboard="{text:'复制的文本'}">复制</com-button>
 * <com-button v-clipboard="{text: function(){ return '复制的文本' }}">复制</com-button>
 */
